							 ...
							 <div class="panel panel-primary">
						      ...
						      <?php foreach($data as $list) { ?>
						      	<form class="form-horizontal">
									...
									<div class="form-group">
										<label for="input" class="col-sm-3 control-label">Telepon Kost</label>
										<div class="col-sm-9">
											<p class="p_adjust"><?php echo $list->telp_kost;?></p>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="input" class="col-sm-3 control-label">Alamat Kost</label>
										<div class="col-sm-9">
											<p class="p_adjust"><?php echo $list->alamat_kost;?></p>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="input"   class="col-sm-3 control-label">Riwayat sakit</label>
										<div class="col-sm-9">
											<p class="p_adjust"><?php echo $list->riwayat_sakit;?></p>
										</div>
									</div>
									<div class="form-group">
										<label for="input" class="col-sm-3 control-label">Tinggal Dengan</label>
										<div class="col-sm-9">
											<p class="p_adjust"><?php echo $list->tinggal_dengan;?></p>
										</div>
									</div>
									</div>
						      		<div class="col-md-5">
										...
										<div class="form-group">
											<label for="input" class="col-sm-3 control-label">Asal Sekolah</label>
											<div class="col-sm-9">
												<p class="p_adjust"><?php echo $list->asal_sekolah;?></p>
											</div>
										</div>
										<div class="form-group">
											<label for="input" class="col-sm-3 control-label">Jumlah SKHU</label>
											<div class="col-sm-9">
												<p class="p_adjust"><?php echo $list->jumlah_skhu;?></p>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="input" class="col-sm-3 control-label">IQ Siswa</label>
											<div class="col-sm-9">
												<p class="p_adjust"><?php echo $list->iq_siswa;?></p>
											</div>
										</div>
										<div class="form-group">
											<label for="input" class="col-sm-3 control-label">IQ Tanggal</label>
											<div class="col-sm-9">
												<p class="p_adjust"><?php echo  date("d-m-Y", strtotime($list->iq_tanggal));?></p>
											</div>
										</div>
										<div class="form-group">
											<label for="input" class="col-sm-3 control-label">Prestasi</label>
											<div class="col-sm-9">
												<p class="p_adjust"><?php echo $list->prestasi;?></p>
											</div>
										</div>
										<div class="form-group">
											<label for="input" class="col-sm-3 control-label">Prestasi 2</label>
											<div class="col-sm-9">
												<p class="p_adjust"><?php echo $list->prestasi_2;?></p>
											</div>
										</div>
									</div>
									</div>
