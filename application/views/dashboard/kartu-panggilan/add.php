						...
						<div class="col-md-9">
							...
							<nav class="breadcrumb">
							 ...
							 <div class="panel panel-primary">
						      <div class="panel-heading">Formulir Buat Kartu Panggilan</div>
						      <div class="panel-body">
						      		<form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url('KartuPanggilan/save') ;?>">
										<div class="row">
											<div class="col-md-4">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="jam_ke" class="form-control" id="sasaran1" placeholder="Jam ke..">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="date" name="date" class="form-control" id="sasaran1" placeholder="Jam ke..">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="ruang" class="form-control" id="input" placeholder="Masukan Ruangan..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Menghadap</label>
												<div class="col-sm-9">
													<input type="text" name="menghadap" class="form-control" id="input" placeholder="Masukan menghadap ">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Perihal</label>
												<div class="col-sm-9">
													<input type="text" name="perihal" class="form-control" id="input" placeholder="Masukan Perihal..">
												</div>
											</div>
