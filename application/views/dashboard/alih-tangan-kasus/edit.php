						...
						<div class="col-md-9">
							...
							<nav class="breadcrumb">
							 ...
							 <div class="panel panel-primary">
						      <div class="panel-heading">Formulir Ubah Satkung Alih tangan Kasus</div>
										...
										<div class="row">
											...
											<div class="form-group">
												...
												<div class="input-group">
												  <input value="<?php echo $list->nis;?>" type="text" name="nis" class="form-control" id="nis" placeholder="Masukan NIS..">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input value="<?php echo $list->topik;?>" type="text" name="topik" class="form-control" id="input" placeholder="Masukan Topik / Permasalahan..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Bidang Bimbingan</label>
												<div class="col-sm-9">
													<input value="<?php echo $list->bidang_bimbingan;?>"  type="text" name="bidang_bimbingan" class="form-control" id="input" placeholder="Masukan Bidang Bimbingan ">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Jenis Kegiatan</label>
												<div class="col-sm-9">
													<input value="<?php echo $list->jenis_kegiatan;?>" type="text" name="jenis_kegiatan" class="form-control" id="input" placeholder="Masukan Jenis kegiatan..">
												</div>
											</div>
												<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Fungsi Kegiatan</label>
												<div class="col-sm-9">
													<input value="<?php echo $list->fungsi_kegiatan;?>" type="text" name="fungsi_kegiatan" class="form-control" id="input" placeholder="Masukan fungsi kegiatan..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Tujuan Kegiatan</label>
												<div class="col-sm-9">
													<input value="<?php echo $list->tujuan_kegiatan;?>" type="text" name="tujuan_kegiatan" class="form-control" id="input" placeholder="Masukan Tujuan kegiatan..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Hasil yang ingin dicapai</label>
												<div class="col-sm-9">
													<input value="<?php echo $list->hasil;?>" type="text" name="hasil" class="form-control" id="input" placeholder="Masukan Hasil yang ingin dicapai..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Subjek yang mengalami masalah</label>
												<div class="col-sm-9">
													<input value="<?php echo $list->subjek;?>" type="text" name="subjek" class="form-control" id="input" placeholder="Subjek yang mengalami masalah..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Gambaran ringkas masalah</label>
												<div class="col-sm-9">
												<input value="<?php echo $list->ringkas;?>" type="text" name="ringkas" class="form-control" id="input" placeholder="Gambaran ringkas masalah..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Kepada siapa di alih tangankan</label>
												<div class="col-sm-9">
													<input value="<?php echo $list->kepada;?>" type="text" name="kepada" class="form-control" id="input" placeholder="Kepada siapa di alih tangankan..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Alasan pengalihan tangan</label>
												<div class="col-sm-9">
													<input value="<?php echo $list->alasan;?>" type="text" name="alasan" class="form-control" id="input" placeholder="Masukan Alasan pengalihan tangan..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Kapan pengalihan tangan</label>
												<div class="col-sm-9">
													<input value="<?php echo $list->kapan;?>" type="text" name="kapan" class="form-control" id="input" placeholder="Masukan kapan pengalihan tangan..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Bahan yang disertakan dalam alih tangan</label>
												<div class="col-sm-9">
													<input value="<?php echo $list->bahan;?>" type="text" name="bahan" class="form-control" id="input" placeholder="Masukan bahan yang disertakan dalam alih tangan..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Kegiatan pendukung terdahulu</label>
												<div class="col-sm-9">
													<input type="text" value="<?php echo $list->pendukung;?>" name="pendukung" class="form-control" id="input" placeholder="Masukan kegiatan pendukung terdahulu..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Rencana penilaian / tindak lanjut kegiatan</label>
												<div class="col-sm-9">
													<input type="text" value="<?php echo $list->tindak_lanjut;?>" name="tindak_lanjut" class="form-control" id="input" placeholder="Masukan Rencana penilaian..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Catatan khusus</label>
												<div class="col-sm-9">
													<input type="text" value="<?php echo $list->catatan_khusus;?>" name="catatan_khusus" class="form-control" id="input" placeholder="Masukan Catatan khusus..">
												</div>
											</div>
											<input id="id_student" type="hidden" value="<?php echo $list->id_student;?>" name="id_student">
											<input id="id_student" type="hidden" value="<?php echo $list->id_satkung_alih_tangan_kasus;?>" name="id_satkung_alih_tangan_kasus">
											<div class="form-group">
