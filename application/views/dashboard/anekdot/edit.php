						...
						<div class="col-md-9">
							...
							<nav class="breadcrumb">
							 ...
							 <div class="panel panel-primary">
						      <div class="panel-heading">Formulir Ubah Catatan Anekdot</div>
						      		...
						      		<form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url('Anekdot/update') ;?>">
										<div class="row">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input value="<?php echo $list->tgl_kejadian;?>" type="date" name="tgl_kejadian" class="form-control" placeholder="Tanggal kejadian..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Tempat Kejadian</label>
												<div class="col-sm-9">
													<input value="<?php echo $list->tempat_kejadian;?>" type="text" name="tempat_kejadian" class="form-control" id="input" placeholder="Masukan tempat kejadian.. ">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<textarea style="text-align:justify" placeholder="Masukkan keterangan kejadian.." name="ket_kejadian" class="text-left control-label form-control" rows="5" cols="30"><?php echo $list->ket_kejadian;?></textarea>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<textarea style="text-align:justify" placeholder="Masukkan tindak lanjut kejadian.." name="tindak_lanjut" class="text-left control-label form-control" rows="5" cols="30"><?php echo $list->tindak_lanjut;?></textarea>
												</div>
											</div>

											<input id="id_student" type="hidden" value="<?php echo $list->id_student;?>" name="id_student">

											<input id="id_anekdot" type="hidden" value="<?php echo $list->id_anekdot;?>" name="id_anekdot">
