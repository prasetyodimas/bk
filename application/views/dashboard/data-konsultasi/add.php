							...
							<nav class="breadcrumb">
							 ...
							 <div class="panel panel-primary">
						      ...
						      <div class="panel-body">
						      		<form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url('DataKonsultasi/save') ;?>">
										<div class="row">
											<div class="col-md-4">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="menghadap" class="form-control" id="sasaran1" placeholder="Menghadap..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Jam ke</label>
												<div class="col-sm-9">
													<input type="text" name="jam_ke" class="form-control" id="input" placeholder="Masukan jam ke..">
												</div>
											</div>
												<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="selesai_pukul" class="form-control" id="input" placeholder="Masukan selesai pukul.. ">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Jam ke</label>
												<div class="col-sm-9">
													<input type="text" name="selesai_jam" class="form-control" id="input" placeholder="Masukan jam selesai pukul..">
												</div>
											</div>
