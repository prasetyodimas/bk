							...
							<nav class="breadcrumb">
							 ...
							 <div class="panel panel-primary">
						      ...
						      <div class="panel-body">
						      		<form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url('SuratUndanganOrangTua/save') ;?>">
										<div class="row">
											<div class="col-md-4">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" name="no_surat" class="form-control" id="sasaran1" placeholder="No surat..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Perihal</label>
												<div class="col-sm-9">
													<input type="text" name="perihal" class="form-control" id="sasaran1" placeholder="Perihal..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Orang Tua</label>
												<div class="col-sm-9">
													<input type="text" name="orang_tua" class="form-control" id="sasaran1" placeholder="Orang tua..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Di</label>
												<div class="col-sm-9">
													<input type="text" name="di" class="form-control" id="sasaran1" placeholder="Di..">
												</div>
											</div>
											<div class="form-group">
