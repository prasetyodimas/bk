							 ...
							 <div class="panel panel-primary">
						      		...
						      		<form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url('RujukanAlihTanganKasus/update') ;?>">
										<div class="row">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
														<textarea id="alamat" style="text-align:justify" name="alamat" class="text-left control-label form-control" rows="5" cols="30"><?php echo $list->alamat_rumah;?></textarea>
												</div>
											</div>
												</div>
												<div class="col-md-8">
						      <div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" value="<?php echo $list->perihal;?>" name="perihal" class="form-control" id="input" placeholder="Perihal..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Pekerjaan</label>
												<div class="col-sm-9">
													<input type="text" value="<?php echo $list->pekerjaan;?>" name="pekerjaan" class="form-control" id="input" placeholder="pekerjaan..">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<textarea style="text-align:justify" placeholder="masalah yang sedang dihadapi.." name="masalah" class="text-left control-label form-control" rows="5" cols="30"><?php echo $list->masalah;?></textarea>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<textarea style="text-align:justify" placeholder="Laporan hasil koseling.." name="hasil_konseling" class="text-left control-label form-control" rows="5" cols="30"><?php echo $list->hasil_konseling;?></textarea>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<textarea style="text-align:justify" placeholder="Catatan khusus.." name="catatan_khusus" class="text-left control-label form-control" rows="5" cols="30"><?php echo $list->catatan_khusus;?></textarea>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" value="<?php echo $list->yang_diundang;?>" name="yang_diundang" class="form-control" id="input" placeholder="Bapak / Ibu .. ">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Jabatan</label>
												<div class="col-sm-9">
													<input type="text" value="<?php echo $list->jabatan;?>" name="jabatan" class="form-control" id="input" placeholder="Jabatan..">
												</div>
											</div>
											<div class="form-group">
												<label for="input" class="col-sm-3 control-label">Di</label>
												<div class="col-sm-9">
													<input type="text" value="<?php echo $list->di;?>" name="di" class="form-control" id="input" placeholder="di..">
												</div>
											</div>
										<input id="id_student" type="hidden" value="<?php echo $list->id_student;?>" name="id_student">
										<input id="id_student" type="hidden" value="<?php echo $list->id_rujukan_alih_tangan_kasus;?>" name="id_rujukan_alih_tangan_kasus">
											<div class="form-group">
